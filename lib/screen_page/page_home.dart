...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<ModelKampus> fetchKampus() async {
    final response = await http.get(Uri.parse('http://192.168.56.1/project_kampus/getBerita.php'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Ilham Rizqy Maulana'),
    ...
    final imageUrl = 'http://192.168.56.1/project_kampus/gambar/${kampus.gambar}';
    return InkWell(
    onTap: () {
    Navigator.push(
    context,
